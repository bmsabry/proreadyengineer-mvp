...
async def get_runtime_config(db: AsyncSession) -> Dict[str, Any]:
    ...
    def _get(key: str, default: str = '') -> str:
        val = (
            db_cfg.get(key)                    # exact case e.g. RESEND_API_KEY
            or db_cfg.get(key.lower())         # lowercase e.g. resend_api_key (Admin Settings stores this way)
    ...
    return {
        ...
        'EMBEDDING_API_BASE'    : _get('EMBEDDING_API_BASE'),
        ...
        'SMTP_TLS'              : _get('SMTP_TLS', 'true'),
        'SMTP_SSL'              : _get('SMTP_SSL', 'false'),
        ...
        'RENDER_API_KEY'               : _get('RENDER_API_KEY'),
        'RENDER_MONTHLY_BUDGET'        : _get('RENDER_MONTHLY_BUDGET'),
    }
