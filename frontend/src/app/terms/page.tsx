        ...
        <div className="space-y-10">
          ...
          <Section title="6. Payment Terms">
            ...
            <div className="bg-muted rounded-lg p-4 text-sm divide-y divide-border">
              ...
              <div className="flex justify-between py-2"><span>NDA Document Handling Fee</span><span className="font-semibold">$5.00</span></div>
              ...
              <div className="flex justify-between py-2"><span>Search Tier 1 &mdash; 100 searches/mo</span><span className="font-semibold">$10.00/mo</span></div>
            ...
            <p className="leading-relaxed">
              All payments processed via Stripe or PayPal. Subscriptions renew monthly until
