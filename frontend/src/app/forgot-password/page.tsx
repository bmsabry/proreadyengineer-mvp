        ...
        {isSubmitted ? (
          ...
          <>
            <div className="px-8 pt-8 pb-6">
              <div className="w-12 h-12 rounded-xl bg-[#0F2B54]/8 flex items-center justify-center mb-5">
                <svg className="w-6 h-6 text-[#0F2B54]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
