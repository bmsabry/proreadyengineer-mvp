...
async def login(
    ...
    # Use secure=False for testing; in production, use secure=True
...
async def refresh_token(
    ...
    response = TokenPairResponse(access_token=new_access, refresh_token=new_refresh, user=user_response)
    return response
